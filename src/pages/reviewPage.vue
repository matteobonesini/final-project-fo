...
<template>
    <div class="container px-5 w-full md:w-3/5  mx-auto">
        <form @submit.prevent="sendReview()" class="pt-10">
            ...
            <div class="mb-6">
                ...
                <div class="flex items-center">
                    <select id="countries" v-model="vote" required
                        class="w-12 me-5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div class="mb-6">
                <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><span
            ...
            <button type="submit"
                class="text-white bg-[--tertiary] font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-[--tertiary] ">Invia</button>
        </form>
    </div>
</template>
