    ...
    <div v-if="developer" class="container mx-auto py-16 px-4">
        ...
        <div class="sm:w-full lg:w-4/5 mx-auto grid sm:grid-cols-1 md:grid-cols-2 gap-10 mb-10">
            ...
            <div class="inline-block">
                <router-link :to="{ name: 'message', params: { id: developer.user.id } }"
            ...
            <div class="inline-block">
                <router-link :to="{ name: 'message', params: { id: developer.user.id } }" class="w-full inline-flex items-center justify-center p-5 text-base font-medium text-gray-500 rounded-lg
                    bg-gray-50 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800
