...
<template>
    <div v-if="developer" class="container mx-auto py-16 px-4">
        <div class="flex justify-evenly items-center mb-10">
            <!-- Profile Picture -->
            <img v-if="developer.profile_picture" class="rounded-lg w-32 object-cover" :src="developer.full_img_src"
                :alt="developer.user.name">
            <img v-else class="rounded-lg w-32 object-cover"
                :src="'https://placehold.co/600x600/1dbf73/FFF/?text=' + developer.user.name" :alt="developer.user.name">
            <div>
                <!-- Developer Name -->
                <h1 class="text-4xl font-bold">{{ developer.user.name }}
                    <div v-if="developer.active_sponsorship" class="inline-block">
                        <svg class="ms-2 h-6 inline-block" viewBox="0 0 24 24" fill="none"
                            ...
                            <g id="SVGRepo_iconCarrier">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    fill="#1dbf73" style="--darkreader-inline-fill: #17995c;"
        ...
        <h2 class="mb-2 pt-3 text-lg text-gray-500 dark:text-gray-400 border-t border-t-gray-200 dark:border-t-gray-700">
            Campi
            di Lavoro</h2>
