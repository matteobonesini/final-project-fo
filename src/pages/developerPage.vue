        ...
        <div class="sm:w-full lg:w-4/5 mx-auto grid sm:grid-cols-1 md:grid-cols-2 gap-10 mb-10">
            ...
            <div class="inline-block">
                <router-link
                    ...
                    class="w-full inline-flex items-center justify-center p-5 text-base font-medium text-gray-700 rounded-lg bg-gray-200 hover:text-gray-900 hover:bg-gray-300 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white">
            ...
            <div class="inline-block">
                <router-link
                    :to="{ name: 'review', params: { id: developer.user.id }, query: { dev: developer.user.name } }" class="w-full inline-flex items-center justify-center p-5 text-base font-medium text-gray-700 rounded-lg
                    bg-gray-200 hover:text-gray-900 hover:bg-gray-300 dark:text-gray-400 dark:bg-gray-800
