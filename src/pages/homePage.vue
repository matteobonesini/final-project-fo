            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                ...
                <div class="flex flex-col space-y-4 md:space-y-0 md:flex-row sm:justify-center space-x-4">
                    ...
                    <router-link :to="{ name: 'search' }">
                        <button type="button"
                            class="focus:outline-none text-white bg-green-500 hover:bg-green-600 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-green-800 dark:hover:bg-green-700">Cerca</button>
                    </router-link>
